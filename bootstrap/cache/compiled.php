...
class BusServiceProvider extends ServiceProvider
{
    ...
    public function provides()
    {
        return ['Illuminate\\Bus\\Dispatcher', 'Illuminate\\Contracts\\Bus\\Dispatcher', 'Illuminate\\Contracts\\Bus\\QueueingDispatcher'];
    }
}
}
...
class EventServiceProvider extends ServiceProvider
{
    protected $listen = ['event.name' => ['EventListener']];
    public function boot(DispatcherContract $events)
    {
        parent::boot($events);
    }
